PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.config.alarm_alert=lava_piano.mp3 \
    ro.config.default_message0=lava_signal.mp3 \
    ro.config.default_message1=lava_signal.mp3 \
    ro.config.default_message=lava_signal.mp3 \
    ro.config.low_ram=true \
    ro.config.notification_sound=lava_signal.mp3 \
    ro.config.ringtone0=lava_angle.mp3 \
    ro.config.ringtone1=lava_angle.mp3 \
    ro.config.ringtone=lava_angle.mp3 \
    ro.control_privapp_permissions=log \
    ro.ge2.mode=gps_beidou \
    ro.hardware.keystore=sprdtrusty \
    ro.hotspot.enabled=1 \
    ro.keybox.id.value=LAVA_iris51_iris51 \
    ...
    ro.sprdlauncher.defaulthome=true \
